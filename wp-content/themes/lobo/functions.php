...
function lobo_update_notice() {
	...
	if ( get_option( 'lobo_version' ) != '2.2' ) {

        echo '<div class="updated" style="position: relative;">
        	<h4>You have just updated to version 2.2 - <a style="text-decoration" href="' . admin_url( 'themes.php?page=ot-theme-options&lobo_update_done_do=1#section_log' ) . '">Read the CHANGELOG</a></h4>';
...
function lobo_update_done_do() {
    ...
    if ( isset( $_GET['lobo_update_done_do'] ) && '1' == $_GET['lobo_update_done_do'] ) {
        update_option( 'lobo_version', '2.2' );
	}
}
