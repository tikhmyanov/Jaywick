...
/*---------------------------------
  ...
  $lobo_folio_lightbox = array(
    'id'        => 'lobo_folio_lightbox',
    'title' => 'Custom ligthbox',
    'desc' => 'If you want this project to open up some content in a lightbox instead the project page, use the fields below to configure them. Just like for the custom URL option, don\'t forget to add the <strong>link</strong> text in the project\'s excerpt, as explained in the manual.',
    'pages' => array( 'portfolio' ),
    'context' => 'side',
    'priority' => 'core',
    'fields' => array(
        ...
        array(
          'label' => 'Iframe',
          'id' => 'lobo_folio_l_iframe',
          'type' => 'textarea-simple',
          'desc' => 'Only add the iframe <strong>src/href</strong>, not the entire iframe object!'
          )
  ...
  $krown_hero_options = array(
    ...
    'fields' => array(
        ...
        array(
          ...
          'type' => 'upload',
          'std' => '',
          'desc' => 'Upload a large image in case you\'ll go with a single image. This asset will be resized to fill the entire screen (though only a certain part will be entirely seen), so make sure that you add a large image.<br><br>An image can also be chosen when you are using a video hero, to stand as a fallback for mobile devices (it replaces the video completely).',
          ),
  ...
  ////////////////////
    ...
    /*---------------------------------
      ...
      ot_register_meta_box( $lobo_folio_lightbox );
